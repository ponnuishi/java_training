...
INSERT INTO employees (name, department, salary) VALUES 
    ('Arjun Reddy', 'Engineering', 75000.00),
    ('Lakshmi Devi', 'Marketing', 65000.00),
    ('Karthik Iyer', 'Engineering', 80000.00),
    ('Anjali Nair', 'HR', 60000.00),
    ('Suresh Menon', 'Marketing', 70000.00);
```
